...
fn main() -> anyhow::Result<()> {
    ...
    let accounts =
        slate_replay::snapshot::load_accounts(File::open(&path)?, Some(&HashSet::from([id])), None)?;
    ...
    println!("  lamports={} rent_epoch={} data={}", a.lamports(), a.rent_epoch(), a.data().len());
    println!("  distribution_starting_block_height={}", e.distribution_starting_block_height);
